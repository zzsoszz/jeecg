...
public class JeecgOneToMainUtil {
	...
	public static void main(String[] args) {
		...
		//第二步：设置子表集合配置
		List<SubTableEntity> subtableslist = new ArrayList<SubTableEntity>();
		//[1].子表一
		...
		*/
		...
		subtableslist.add(po2);
		
		
		
		
		codeParamEntityIn.setSubTabParam(subtableslist);
		//第三步：一对多(父子表)数据模型,代码生成
		CodeGenerateOneToMany.oneToManyCreate(subtableslist, codeParamEntityIn);
	}
}
